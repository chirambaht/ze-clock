...
Wemos-Lolin32-ESP32-OLED
########################

Overview
********

Wemos-Lolin32-ESP32-OLED is a series of low cost, low power system on a chip microcontrollers
...
.. figure:: img/esp32_lolin_oled.png
    :align: center
    :alt: Wemos-Lolin32-ESP32-OLED

    Wemos-Lolin32-ESP32-OLED-32D DK
...
.. zephyr-app-commands::
   ...
   :board: esp32_lolin_oled
   :goals: build

The usual ``flash`` target will work with the ``esp32_lolin_oled`` board
...
.. code-block:: console
   ...
   ***** Booting Zephyr OS vx.x.x-xxx-gxxxxxxxxxxxx *****
   Hello World! esp32_lolin_oled

Debugging
---------

Wemos-Lolin32-ESP32-OLED support on OpenOCD is available upstream as of version 0.12.0.
